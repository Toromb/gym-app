...
void main() {
  group('SwapExerciseLogic Intelligent Reps', () {
    // Mock Data
    final Exercise oldEx =
        Exercise(id: 'old', name: 'Old', muscleGroup: 'Chest');
    ...
    test('General Intent keeps old reps (10) if fit', () {
      final newEx = Exercise(
          id: 'new', name: 'New Gen', muscleGroup: 'Chest'); // No limits
    ...
    test('Strength Intent BUT Exercise Limited (Min 10) -> Respects Exercise',
      ...
      final newEx = Exercise(
          id: 'new', name: 'Abs', muscleGroup: 'Abs', minReps: 10, maxReps: 20);
    ...
    test('Fallback when no overlap and no old reps', () {
      final newEx = Exercise(
          id: 'new', name: 'Abs', muscleGroup: 'Abs', minReps: 12, maxReps: 20);
