...
export class GymSchedule {
  @ApiProperty({
    example: 1,
    description: 'The unique identifier of the schedule record',
  })
  ...
  @ApiProperty({
    example: '08:00',
    description: 'Opening time for the morning shift',
    required: false,
    nullable: true,
  })
  ...
  @ApiProperty({
    example: '12:00',
    description: 'Closing time for the morning shift',
    required: false,
    nullable: true,
  })
  @Column({ type: 'varchar', nullable: true })
  ...
  @ApiProperty({
    example: '16:00',
    description: 'Opening time for the afternoon shift',
    required: false,
    nullable: true,
  })
  @Column({ type: 'varchar', nullable: true })
  ...
  @ApiProperty({
    example: '21:00',
    description: 'Closing time for the afternoon shift',
    required: false,
    nullable: true,
  })
  @Column({ type: 'varchar', nullable: true })
