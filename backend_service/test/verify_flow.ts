async function verify() {
    ...
    try {
        ...
        await request('POST', `/plans/${planId}/assign`, {
            studentId: studentId
        }, teacherToken);
        ...
        const myPlan = await request('GET', '/plans/student/my-plan', undefined, studentToken);
        ...
        if (myPlan && myPlan.id === planId) {
            ...
            console.error(`Verification FAILED: Plan ID mismatch. Expected ${planId}, got ${myPlan?.id}`);
        }
