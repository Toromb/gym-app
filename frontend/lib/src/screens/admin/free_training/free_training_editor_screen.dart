...
class FreeTrainingEditorScreen extends StatefulWidget {
  ...
  @override
  State<FreeTrainingEditorScreen> createState() =>
      _FreeTrainingEditorScreenState();
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                        ...
                        decoration:
                            const InputDecoration(labelText: 'Carga Sugerida')),
                    TextField(
                    ...
                    onPressed: () {
                      setState(() {
                        final newEx = FreeTrainingExercise(
                          id: existing?.id ??
                              '', // ID handled by backend on create, empty for new
                          exercise: selected!,
              ...
              child: ListView(
                ...
                children: [
                  ...
                  DropdownButtonFormField<BodySector>(
                    value: _sector,
                    decoration:
                        const InputDecoration(labelText: 'Sector (Opcional)'),
                    items: [
                      const DropdownMenuItem(
                          value: null, child: Text('Ninguno')),
                      ...BodySector.values.map((e) => DropdownMenuItem(
                          value: e, child: Text(e.name.toUpperCase()))),
                    ],
                  ...
                  DropdownButtonFormField<CardioLevel>(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Nivel Cardio (Opcional)'),
                    items: [
                      const DropdownMenuItem(
                          value: null, child: Text('Ninguno')),
                      ...CardioLevel.values.map((e) => DropdownMenuItem(
                          value: e, child: Text(e.name.toUpperCase()))),
                    ],
                  ...
                  ..._exercises.asMap().entries.map((e) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        subtitle: Text(
                            '${ex.sets}x${ex.reps ?? "?"} ${ex.suggestedLoad != null ? "@ ${ex.suggestedLoad}" : ""}'),
                        trailing: IconButton(
