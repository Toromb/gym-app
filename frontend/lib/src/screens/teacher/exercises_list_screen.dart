...
class _ExercisesListScreenState extends State<ExercisesListScreen> {
    ...
    try {
      ...
      final results = await Future.wait([
        _exerciseService.getExercises(
            muscleId: _selectedMuscleId, equipmentIds: _selectedEquipmentIds),
  ...
  Future<void> _itemsChanged() async {
    setState(() => _isLoading = true);
    try {
      final ex = await _exerciseService.getExercises(
          muscleId: _selectedMuscleId, equipmentIds: _selectedEquipmentIds);
