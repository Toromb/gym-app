...
export class UpdateGymScheduleDto {
    ...
    @ApiProperty({ description: 'Morning Open Time', example: '08:00', required: false })
    @IsOptional()
    @IsString()
    openTimeMorning?: string;

    @ApiProperty({ description: 'Morning Close Time', example: '12:00', required: false })
    @IsOptional()
    @IsString()
    closeTimeMorning?: string;

    @ApiProperty({ description: 'Afternoon Open Time', example: '16:00', required: false })
    @IsOptional()
    @IsString()
    openTimeAfternoon?: string;

    @ApiProperty({ description: 'Afternoon Close Time', example: '21:00', required: false })
    @IsOptional()
    @IsString()
